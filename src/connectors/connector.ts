...
export abstract class Connector<Provider = providers.ExternalProvider, Options = any> {
  // Connector name
  ...
  abstract connect(): Promise<Required<ConnectorData<providers.ExternalProvider>>>;
